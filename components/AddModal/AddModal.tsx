		...
		<div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-6 sm:p-10">
			<div className="bg-white dark:bg-slate-700 rounded-lg shadow-xl w-full max-w-md">
				<div className="p-6 sm:p-8">
					...
					<form className="space-y-4">
						<input
							...
							className="text-sm w-full p-3 rounded-md border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-800 dark:text-white focus:ring-2 focus:ring-blue-500 transition duration-200"
						/>
						<input
							type="text"
							name="address"
				...
				<div className="bg-gray-50 dark:bg-gray-700 px-6 py-4 rounded-b-lg flex justify-end space-x-3">
					<button
						onClick={onCancel}
						className="px-4 py-2 rounded-md text-sm text-gray-600 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-600 transition duration-200"
					>
						Annuler
					</button>
					<button
