...
const IconMenu2 = dynamic(
	() => import("@tabler/icons-react").then((mod) => mod.IconMenu2),
	{
		loading: () => <span>Menu</span>,
		ssr: false,
	}
);
const IconX = dynamic(
	() => import("@tabler/icons-react").then((mod) => mod.IconX),
	{
		loading: () => <span>Fermer</span>,
		ssr: false,
	}
);
	...
	return (
		...
		>
			...
			<motion.span
				...
				className="text-gray-700 dark:text-neutral-200 group-hover/sidebar:translate-x-1 transition duration-150 whitespace-pre inline-block text-lg !p-0 !m-0"
			>
				{link.label}
			</motion.span>
		</Link>
