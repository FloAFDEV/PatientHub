...
const ConfirmDeletePatientModal: React.FC<ConfirmDeletePatientModalProps> = ({
	...
	return (
		<div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-2 sm:p-6 md:p-8">
			<div className="bg-white dark:bg-slate-700 rounded-lg shadow-xl w-full sm:w-4/5 md:w-2/3 lg:w-1/2 max-w-2xl border-4 border-red-600">
				<div className="p-4 sm:p-6">
					...
					<p className="text-sm sm:text-base text-gray-600 dark:text-gray-300 mb-6">
						...
						<div className="font-extrabold text-accent text-xl sm:text-2xl text-amber-500 mt-2 mb-2">
							{patientName}
						</div>
						<span className="font-bold">
							{" "}
					...
					<ul className="list-disc pl-6 mt-2 text-xs sm:text-sm">
						<li>
				...
				<div className="bg-gray-50 dark:bg-gray-700 px-6 py-4 rounded-b-lg flex flex-col sm:flex-row justify-end space-y-3 sm:space-y-0 sm:space-x-3">
					<button
						onClick={onCancel}
						className="px-4 py-2 rounded-md text-gray-600 dark:text-gray-300 hover:bg-gray-300 dark:hover:bg-gray-600 transition duration-200 w-full sm:w-auto"
					>
						Annuler
					</button>
					<button
